...
class BasePage:
    ...
    def page_url(self):
        allure.attach(body=f"page url", name="text attachment", attachment_type=allure.attachment_type.TEXT)
        allure.attach(body=f"page url{self.page.url}", name="text attachment", attachment_type=allure.attachment_type.TEXT)
