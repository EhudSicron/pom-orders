...
class Header_manu_cart(BasePage):
    ...
    __CLOSE_MANU = "#react-burger-cross-btn"
    ...
    def open_menu(self):
        ...
        assert self.page.locator(self.__ALL_ITEMS).is_visible(), f"Open Manu failed - ALL_ITEMS is not visible"
    ...
    def close_manu(self):
         self.click(self.__CLOSE_MANU)
         assert self.page.locator(self.__ALL_ITEMS).is_visible(), f"Close Manu failed - ALL_ITEMS is visible"
